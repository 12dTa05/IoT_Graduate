...
Generates synchronized 4-camera MP4 files with ground truth CSV.
"""
...
# Ensure the repo root is importable when run as `python3 tools/traffic_generator/main.py`
...
def main():
    parser = argparse.ArgumentParser(
        description="Traffic video generator for Edge testing"
    )
    parser.add_argument(
