...
# ── Bandwidth tuning ─────────────────────────────────────────────────────────
# TARGET_FPS: 25 fps is sufficient for vehicle speed detection (40ms resolution
#   at 80 km/h gives sub-meter accuracy). Halving from 60→25 saves ~58% bitrate.
# VIDEO_BITRATE: hard cap at 1.5 Mbps per camera (4 cams = 6 Mbps total LAN).
#   H.264 at 1920×1080@25fps is very readable at this rate for monitoring.
